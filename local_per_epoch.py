...
def make_df_preprocess(sample_csv):
  ...
  print("preprocess time : ",time.time()-ni,"\n")
...
with tf.Session() as sess:
  ...
  for epoch in range(n_epochs):
    if epoch==0:
      f = open("/home/mosl/CDM_sample_data/divide_dataset/data0.txt",'r')
      dat = f.read()
      f.close()
      sample_csv = dat
      sample_csv = sample_csv.replace("\n","")
    ...
    if epoch%100==0:
      ...
      #print(f_num)
      f_name = '/home/mosl/CDM_sample_data/divide_dataset/data'+str(f_num)+'.txt'
