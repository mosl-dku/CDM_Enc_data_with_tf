...
import grpc
import sys
sys.path.insert(1,'/home/jaeseo/sample2/tf_grpc')
...
'''
def run():
	with grpc.insecure_channel('172.25.244.5:50051') as channel:
...
logging.basicConfig()
#f = open("/home/jaeseo/CDM_sample_data/divide_dataset_2/data0.txt.enc",'rb')
#dat = f.read()
#f.close
...
n_epochs = 1000
learning_rate = 0.001
#sample_csv = sendCiphertext(dat,'/home/jaeseo/CDM_sample_data/divide_dataset_2/data0.txt.enc.key')
...
with tf.Session() as sess:
  ...
  for epoch in range(n_epochs):
    if epoch==0:
      f = open("/home/jaeseo/sample2/divide_dataset_3/data0.txt.enc",'rb')
      dat = f.read()
      f.close()
      k = open("/home/jaeseo/sample2/divide_dataset_3/data0.txt.enc.key",'rb')
      e_key = k.read()
      k.close()

      
      sample_csv = sendCiphertext(dat,e_key)
      sample_csv = sample_csv.replace("\n","")
      x_train,x_test,y_train,y_test,test_x,test_y = make_df_preprocess(sample_csv)
    ...
    if epoch%100==0:
      ...
      #print(f_num)
      f_name = '/home/jaeseo/sample2/divide_dataset_3/data'+str(f_num)+'.txt.enc'
      print(f_name)
      k_name = '/home/jaeseo/sample2/divide_dataset_3/data'+str(f_num)+'.txt.enc.key'
